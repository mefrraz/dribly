                ...
                <div className="max-w-5xl mx-auto px-4 relative">
                    {gamesLoading ? (
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute left-0 top-0 bottom-0 w-36 md:w-72 bg-gradient-to-r from-zinc-50 dark:from-zinc-950 to-transparent pointer-events-none z-10 hidden md:block" />
                            <div className="absolute right-0 top-0 bottom-0 w-36 md:w-72 bg-gradient-to-l from-zinc-50 dark:from-zinc-950 to-transparent pointer-events-none z-10 hidden md:block" />
                        </div>
                    )}
                </div>
            </div>
